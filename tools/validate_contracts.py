...
def windows_preview_presentation_session_contract() -> None:
    ...
    for token in [
        ...
        "clip end lost its boundary receipt",
...
def windows_qt_preview_host_contract() -> None:
    ...
    require_equal(
        ...
        contract.get("excluded"),
        [
            "leading and inter-segment gap cadence",
    ...
    for token in [
        ...
        "project_render::staticVideoLayerAt(",
        "state->session.reset()",
        "window_.release()",
    ...
    for token in [
        ...
        "timelineRangeAdmitsCrossClipSeekAndRefusesEnd",
        "controller.maximumFrame(), qint64{39}",
        ...
        "tickGenerationTransitionContinuesCadence",
